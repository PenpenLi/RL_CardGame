...
public class BattleManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        SDL = GetComponent<SkillDetailsList>();
    }
    void Start()
    {
    ...
    void FixedUpdate()
    {
        ...
        {
            if (SDDataManager.Instance.SettingData.isAutoBattle && _currentActionPanel != null)
            {
                IsWaitingPlayerAction = false;
    ...
    {
        Unit.ChangeModelAnim(SDConstants.AnimName_JUMP);
        yield return new WaitForSeconds(0.6f);
        Unit.ChangeModelAnim(SDConstants.AnimName_IDLE, true);
    }
    #endregion
    #region actionBar
    ...
    public void BattleSuccess()
    {
        if(SDGameManager.Instance.currentLevel % SDConstants.LevelNumPerSection
            ...
            && SDGameManager.Instance.currentLevel != 0)
        {
