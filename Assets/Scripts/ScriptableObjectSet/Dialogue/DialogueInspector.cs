...
public class DialogueInspector : Editor
{
    ...
    {
        npcs = Resources.LoadAll<TalkerInfo>("");
    ...
    void HandlingWordsList()
    {
        ...
        wordsList.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
        {
            ...
            int oIndex = talkerType.enumValueIndex == 1 ? 0 : (useUnifiedNPC.boolValue ? 1 : (GetNPCIndex(talkerInfo.objectReferenceValue as TalkerInfo) + 1));
    ...
    int GetNPCIndex(TalkerInfo npc)
    {
