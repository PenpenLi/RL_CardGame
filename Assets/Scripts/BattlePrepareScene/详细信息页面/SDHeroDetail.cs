...
public class SDHeroDetail : BasicRoleProperty
{
    ...
    public void setHero(int hashcode)
    {
        ...
        int id = SDDataManager.Instance.getHeroIdByHashcode(hashcode);
        Id = id;
        ...
        RarityText.text = rarityString(dal.quality);
        //RaceIconImg.sprite =
    ...
    public void setWeapon(int hashcode)
    {
        ...
        if (armor == null || armor.equipId == 0 || armor.hashcode == 0)
        {
