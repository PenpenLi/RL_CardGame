...
public class HP_Controller : MonoBehaviour
{
    ...
    public IEnumerator IEShowDamageAnim(int dmg)
    {
        ...
        _unit.unit_character_model.CurrentCharacterModel.ChangeModelAnim(SDConstants.AnimName_HURT);
        yield return new WaitForSeconds(0.25f);
        _unit.unit_character_model.CurrentCharacterModel.ChangeModelAnim(SDConstants.AnimName_IDLE, true);
    }
