...
public class OneAltarData : MonoBehaviour
{
    ...
    public void refreshThisPool()
    {
        ...
        {
            int oneTimeCouponNum = SDDataManager.Instance.getMaterialNum(3010017);
            int tenTimeCouponNum = SDDataManager.Instance.getMaterialNum(3010018);
        ...
        {
            int rareRoleCouponNum = SDDataManager.Instance.getMaterialNum(10019);
